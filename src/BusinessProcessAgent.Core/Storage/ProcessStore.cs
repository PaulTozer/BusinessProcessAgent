...
/// <summary>
/// PostgreSQL-backed storage for observation sessions, process steps, and
...
public sealed class ProcessStore : IDisposable
{
    ...
    public ProcessStore(string connectionString, ILogger<ProcessStore> logger)
    {
    ...
    private void EnsureSchema()
    {
        ...
        cmd.CommandText = """
            ...
            """;
        cmd.ExecuteNonQuery();
        _logger.LogInformation("ProcessStore schema ensured on PostgreSQL");
    }
    ...
    public async Task<long> InsertStepAsync(ProcessStep step)
    {
        ...
        try
        {
            ...
            cmd.Parameters.AddWithValue("@timestamp", step.Timestamp);
    ...
    private static ProcessStep ReadStep(NpgsqlDataReader reader)
    {
